...
- ⬜ **הבא בתור**: לוודא שה-build הופיע ב-TestFlight, להוסיף Test Information (מה לבדוק), ולהתחיל בדיקה פנימית. במקביל — למלא את דף החנות (App Store Connect → App Information/Pricing/Privacy) לפי `docs/app-store-listing.md`, ולצלם מסכים אמיתיים.
