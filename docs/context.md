...
- ⬜ **נשאר לעשות**: לוודא build #8 מופיע ב-TestFlight ולבדוק שלא קורס (הבדיקה הקריטית ביותר כרגע) + Sign in with Apple/Google/ATT + לצלם מסכים אמיתיים → למלא צילומי מסך בדף החנות → Submit ל-Review.
