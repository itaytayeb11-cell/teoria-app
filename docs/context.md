...
- ⬜ **נשאר לעשות**: App Privacy nutrition label (שאלון נפרד ומורכב יותר — לא נעשה עדיין), Pricing (₪19.90 ל-IAP כבר הוגדר דרך RevenueCat; מחיר האפליקציה עצמה = חינם, לא אומת שזה מוגדר בפועל ב-App Store Connect), צילומי מסך אמיתיים (עדיין לא נפתר — האוטומציה על הסימולטור לא אמינה), Secondary category (אופציונלי), Copyright field.
