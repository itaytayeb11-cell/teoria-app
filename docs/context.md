...
- ⬜ **נשאר לעשות**: App Privacy nutrition label (שאלון נפרד — טרם נעשה, מורכב ורגיש משפטית, מתוכנן לעשות דרך הממשק עם Claude-in-Chrome ולא API כי הסכמה על הצהרת פרטיות רשמית), **build חדש** ל-iOS שיכלול את תיקון ה-ATT, צילומי מסך אמיתיים (עדיין לא נפתר — האוטומציה על הסימולטור לא אמינה), Secondary category (אופציונלי), Copyright field.
