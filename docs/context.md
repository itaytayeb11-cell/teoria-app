...
- ⬜ **נשאר לעשות**: לוודא build #7 מופיע ב-TestFlight בפועל ולבדוק (Sign in with Apple, Google, ATT prompt) + לצלם מסכים אמיתיים מהמכשיר, תזכורת יומן לחידוש Apple client secret (מרץ 2027), ואז ה-build הסופי (כולל עיצוב) + Submit ל-Review.
