...
export default function SignUpScreen() {
  ...
  const onSignUpPress = async () => {
    ...
    if (password.length < 8) {
      Alert.alert('שגיאה', 'סיסמה חייבת להיות לפחות 8 אותיות או מספרים');
      return;
    }
            ...
            <View className="mb-5">
              ...
              <View className="relative">
                <TextInput
                  ...
                  placeholder="לפחות 8 אותיות או מספרים"
                  placeholderTextColor="#52525b"
              ...
              {/* טקסט עזר לדרישות הסיסמה */}
              <Text
                className="text-zinc-500 text-xs mt-2"
                style={{ textAlign: rtl.textAlign }}
              >
                סיסמה חייבת להיות לפחות 8 אותיות או מספרים
              </Text>
            </View>
